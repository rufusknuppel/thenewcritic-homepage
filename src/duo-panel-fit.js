  ...
  function fit(panel) {
    ...
    group.forEach(function(el){
      ...
      if (el.classList.contains('card-preview-block')) {
        ...
        // line inside scGap's budget — as many whole lines as fit — and
        // the sub-line slack moves above the title, same as the
        // multi-column path (see the slack padding at the end of fit()).
        var scGap = 16;
